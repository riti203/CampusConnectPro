        ...
        <div class="app-container" >
            ...
            <div class="d-flex align-items-center mb-3">
              ...
              <ol class="breadcrumb">
                <li class="breadcrumb-item">
                  <i class="bi bi-house"></i>
                  <a href="<?=base_url('dashboard');?>" class="text-decoration-none">Home</a>
                </li>
                <li class="breadcrumb-item" aria-current="page">Manage Courses</li>
              </ol>
              <!-- Breadcrumb end -->
          ...
          <div class="app-body" >
            ...
            <div class="row gx-3">
              ...
              <label><i class="bi bi-info-circle-fill"></i>&nbsp;Curriculum</label>
                              <div class="dropdown">
                ...
                <div class="card mb-3">
                  <div class="card-body">
                    <div class="d-flex align-items-center flex-column">
                      <div class="mb-3">
                        <img src="<?=base_url('assetsdb');?>/images/icon1.png" class="img-6x rounded-circle" alt="Admin Dashboards" />
                      </div>
                      <h5 class="mb-2">BTECH</h5>
                      <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.</p>
                      <div class="mt-3">
                        <a href="<?=base_url('editcourse');?>"><span class="btn btn-success">Edit</span></a>
                        <a class="btn btn-danger btn-icon btn-sm "  href="#"><i class="bi bi-trash"  data-bs-toggle="modal" data-bs-target="#exampleModal"></i>
                              </a>
                              <!-- Modal -->
                              <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                  <div class="modal-dialog">
                                    <div class="modal-content">
                                      ...
                                      <div class="modal-body">Are You Sure You Wanna Delete the Degree?</div>

                    ...
                    <div class="row gx-3">
                      ...
                      <div class="col-lg-3 col-sm-4 col-12">
                        <div class="mb-3">
                          ...
                          <input type="email" class="form-control" placeholder="Enter Date Of Joining" />
                        </div>
                      </div>
                      <div class="col-lg-3 col-sm-4 col-12">
                        <div class="mb-3">
                      ...
                      <div class="col-lg-3 col-sm-4 col-12">
                        <div class="mb-3">
                          ...
                          <input type="email" class="form-control" placeholder="Enter Department" />
                        </div>
                      </div>
                      <div class="col-lg-3 col-sm-4 col-12">
                        <div class="mb-3">
                          <label class="form-label">Designation</label>
                          <input type="email" class="form-control" placeholder="Enter Designation" />
                        </div>
                      </div>
                      <div class="col-lg-3 col-sm-4 col-12">
                        <div class="mb-3">

                      ...
                      <table class="table align-middle table-hover m-0">
                        ...
                        <tbody>
                          ...
                          <tr class="grd-primary-light">
                            <td>01</td>
                            <th scope="row">
                              <img class="rounded-circle img-3x me-2" src="<?=base_url('assetsdb');?>/images/user.png"
                            ...
                            <td>HOD CSE</td>
                            <td>
                              <div class="form-check form-switch" style="left: 50%;right: 50%;transform: translate(-30%,0%);position: relative; ">
                              <input class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckChecked"
                        checked="" />
                      </div>
                            </td>
                            <td>
                              <a class="btn btn-info btn-sm" href="<?=base_url('editstaff');?>"><i class="bi bi-pencil"></i>
                              </a>
                            </td>
                            <td>
                              <a class="btn btn-danger btn-icon btn-sm mb-1" href="#"><i class="bi bi-trash" data-bs-toggle="modal" data-bs-target="#exampleModal"></i>
                              </a>
                              <!-- Modal -->
                              <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                  <div class="modal-dialog">
                                    <div class="modal-content">
                                      ...
                                      <div class="modal-body">Are You Sure You Wanna Delete the Student?</div>
